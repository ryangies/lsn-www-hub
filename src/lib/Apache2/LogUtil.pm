...
# If $Log is a package var, and you use set_request($r), then do so in each 
# handler.  When $r is invalid, you will see this in your log files:
#
#   child pid %d exit signal Segmentation fault (11)
#
